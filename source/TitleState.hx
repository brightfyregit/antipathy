...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		{*/
			...
			henk = new FlxSprite(-100, 50);
			henk.frames = Paths.getSparrowAtlas('title screen hank');
			henk.animation.addByPrefix('idle', 'hank shmoving', 24);
			henk.scale.set(0.8, 0.8);
			henk.antialiasing = true;
			add(henk);
